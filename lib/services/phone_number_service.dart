...
class PhoneNumberService {
  static const MethodChannel _channel = MethodChannel(
    AppConstants.phoneNumberChannel,
  );
  ...
  static Future<String?> _getAndroidPhoneNumber() async {
    return await _getPhoneNumberFromChannel();
  }
  ...
  /// Método común para obtener el número de teléfono desde el canal nativo
  static Future<String?> _getPhoneNumberFromChannel() async {
    try {
  ...
  static String encryptPhoneNumber(String phoneNumber) {
    ...
    final bytes = utf8.encode(
      '${AppConstants.phoneEncryptionKey}$normalizedPhone',
    );
  ...
  static Future<Map<String, String>> getDeviceInfo() async {
    final phoneNumber = await getPhoneNumber();
    final canAccess = phoneNumber != null && phoneNumber.isNotEmpty;
